...
const translations = {
  en: {
    ...
    'auth.agree_privacy_prefix': 'I agree to the',
...
'recipe.add_recipe': 'Add Recipe',
    ...
    'currency.search_placeholder': 'Search currency (code or name)',
    'currency.saved_success': 'Currency saved',
    'currency.save_failed': 'Failed to save currency',
    ...
    'privacy.updated': 'Last updated: August 2025',
    'privacy.sections.collection.title': 'Information We Collect',
    'privacy.sections.collection.content': 'We collect information you provide (such as name, email, farm details), usage data, and device information to improve our services.',
    'privacy.sections.usage.title': 'How We Use Your Information',
    'privacy.sections.usage.content': 'We use data to provide and improve the app, personalize features, send notifications, and ensure security and compliance.',
    'privacy.sections.storage.title': 'Data Storage & Security',
    'privacy.sections.storage.content': 'Your data is stored securely with Supabase. We apply reasonable safeguards, but no system is 100% secure.',
    'privacy.sections.rights.title': 'Your Rights',
    'privacy.sections.rights.content': 'You can access, correct, or delete your data, subject to legal obligations. Contact us to exercise your rights.',
    'privacy.sections.contact.title': 'Contact Us',
    'privacy.sections.contact.content': 'For privacy questions or requests, contact support@ternakin.com.',

    // Terms of Service
    'tos.title': 'Terms of Service',
    'tos.updated': 'Last updated: August 2025',
    'tos.sections.use.title': 'Use of the App',
    'tos.sections.use.content': 'Use the app responsibly and in compliance with applicable laws. Do not misuse or attempt to disrupt the service.',
    'tos.sections.account.title': 'Accounts & Security',
    'tos.sections.account.content': 'You are responsible for maintaining the confidentiality of your account and for all activities under your account.',
    'tos.sections.content.title': 'User Content',
    'tos.sections.content.content': 'You retain ownership of content you submit. You grant us a license to use and display it within the app to provide services.',
    'tos.sections.liability.title': 'Limitation of Liability',
    'tos.sections.liability.content': 'We are not liable for indirect, incidental, or consequential damages arising from your use of the app.',
    'tos.sections.termination.title': 'Termination',
    'tos.sections.termination.content': 'We may suspend or terminate access if you violate these terms or laws. You can stop using the app at any time.',
    'tos.sections.changes.title': 'Changes to Terms',
    'tos.sections.changes.content': 'We may update these terms. Continued use of the app after changes means you accept the updated terms.',
    'tos.sections.contact.title': 'Contact Us',
    'tos.sections.contact.content': 'For questions about these terms, contact support@ternakin.com.',
    'common.edit': 'Edit',
  ...
  id: {
    // Auth
    'auth.login': 'Masuk',
    'auth.agree_privacy_prefix': 'Saya setuju dengan',
...
'recipe.add_recipe': 'Tambah Resep',
    ...
    'settings.currency': 'Pengaturan Mata Uang',

    // Currency Settings
    'currency.title': 'Pengaturan Mata Uang',
    'currency.search_placeholder': 'Cari mata uang (kode atau nama)',
    'currency.saved_success': 'Mata uang disimpan',
    'currency.save_failed': 'Gagal menyimpan mata uang',
    ...
    'privacy.updated': 'Terakhir diperbarui: Agustus 2025',
    'privacy.sections.collection.title': 'Informasi yang Kami Kumpulkan',
    'privacy.sections.collection.content': 'Kami mengumpulkan informasi yang Anda berikan (seperti nama, email, detail peternakan), data penggunaan, dan informasi perangkat untuk meningkatkan layanan.',
    'privacy.sections.usage.title': 'Bagaimana Kami Menggunakan Informasi Anda',
    'privacy.sections.usage.content': 'Kami menggunakan data untuk menyediakan dan meningkatkan aplikasi, mempersonalisasi fitur, mengirim notifikasi, serta memastikan keamanan dan kepatuhan.',
    'privacy.sections.storage.title': 'Penyimpanan & Keamanan Data',
    'privacy.sections.storage.content': 'Data Anda disimpan dengan aman menggunakan Supabase. Kami menerapkan pengamanan yang wajar, namun tidak ada sistem yang 100% aman.',
    'privacy.sections.rights.title': 'Hak Anda',
    'privacy.sections.rights.content': 'Anda dapat mengakses, memperbaiki, atau menghapus data Anda, sesuai kewajiban hukum yang berlaku. Hubungi kami untuk menggunakan hak Anda.',
    'privacy.sections.contact.title': 'Hubungi Kami',
    'privacy.sections.contact.content': 'Untuk pertanyaan atau permintaan terkait privasi, hubungi support@ternakin.com.',

    // Terms of Service
    'tos.title': 'Ketentuan Layanan',
    'tos.updated': 'Terakhir diperbarui: Agustus 2025',
    'tos.sections.use.title': 'Penggunaan Aplikasi',
    'tos.sections.use.content': 'Gunakan aplikasi secara bertanggung jawab dan sesuai dengan hukum yang berlaku. Jangan menyalahgunakan atau mencoba mengganggu layanan.',
    'tos.sections.account.title': 'Akun & Keamanan',
    'tos.sections.account.content': 'Anda bertanggung jawab menjaga kerahasiaan akun dan semua aktivitas di bawah akun Anda.',
    'tos.sections.content.title': 'Konten Pengguna',
    'tos.sections.content.content': 'Anda tetap memiliki konten yang Anda kirimkan. Anda memberikan lisensi kepada kami untuk menggunakan dan menampilkannya dalam aplikasi guna menyediakan layanan.',
    'tos.sections.liability.title': 'Batasan Tanggung Jawab',
    'tos.sections.liability.content': 'Kami tidak bertanggung jawab atas kerusakan tidak langsung, insidental, atau konsekuensial yang timbul dari penggunaan aplikasi.',
    'tos.sections.termination.title': 'Penghentian',
    'tos.sections.termination.content': 'Kami dapat menangguhkan atau menghentikan akses jika Anda melanggar ketentuan ini atau hukum. Anda dapat berhenti menggunakan aplikasi kapan saja.',
    'tos.sections.changes.title': 'Perubahan Ketentuan',
    'tos.sections.changes.content': 'Kami dapat memperbarui ketentuan ini. Penggunaan berkelanjutan setelah perubahan berarti Anda menerima ketentuan yang diperbarui.',
    'tos.sections.contact.title': 'Hubungi Kami',
    'tos.sections.contact.content': 'Untuk pertanyaan tentang ketentuan ini, hubungi support@ternakin.com.',
    'common.edit': 'Edit',
    'common.delete': 'Hapus',
    'common.yes': 'Ya',
    'common.no': 'Tidak',
